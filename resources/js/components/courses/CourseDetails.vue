        ...
        <div v-if="!loading">
            ...
            <div class="container bg-white">
                <div class="row justify-content-around align-items-center border-bottom border-primary">
                    ...
                    <div class="col-md-3">
                        <a :href="'https://www.facebook.com/sharer/sharer.php?s=100&p[url]='+this.$route.path+'&p[images][0]=&p[title]='+course.name+'&p[summary]='+course.description"> <img src="../../assets/images/fb.png" alt="fb" width="150px"></a> <br>
                    </div>
                    <div class="col-md-2">
